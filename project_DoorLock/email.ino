...
void capturePhotoSaveSpiffs( void ) {
  ...
  do {
    ...
    // 파일이 SPIFFS에 성공적으로 촬영되어 저장되었는지 확인
...
void sendPhoto( void ) {
  ...
  // 로그인에 사용되는 SMTP서버 호스트, SMTP포트, 계정 이메일 주소 및 비밀번호 설정 
  ...
  // Add attach files from SPIFFS // Set the storage type to attach files in your email (SPIFFS)
